...
interactions = get_data_parquet(interactions_upd_link)
movies_md = get_data_parquet(movies_md_upd_link)
int_coef = get_data_parquet(int_coef_link)
cos_sim_md = load_matrix(cos_sim_md_link)
cos_sim_desc = load_matrix(cos_sim_desc_link)
